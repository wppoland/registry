<?php
/**
 * Plugin Name:       Plogins Registry - Gift Registry for WooCommerce
...
add_action('plugins_loaded', static function (): void {
    if (! class_exists('WooCommerce')) {
        add_action('admin_notices', static function (): void {
            ...
            echo esc_html__('Plogins Registry - Gift Registry for WooCommerce requires WooCommerce to be active.', 'plogins-registry');
            echo '</p></div>';
        });
        return;
    }
