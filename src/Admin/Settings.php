                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description"><?php esc_html_e('On (recommended): a guest clicks "Buy this gift" on the registry and the item drops into their cart in one step. Off: the button instead sends them to the product page, where they choose options before adding to cart, useful for variable products that need a size or colour picked first. Has no effect unless gift registries are enabled above.', 'plogins-registry'); ?></p>
